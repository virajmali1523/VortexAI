...
export class ChatService {
  ...
  getSession(id: string): Observable<ChatSession> {
    return this.http.get<ChatSession>(`${this.apiUrl}/history/${id}`);
  }

  // Save/update a session
  saveSession(session: ChatSession): Observable<ChatSession> {
    return this.http.post<ChatSession>(`${this.apiUrl}/history`, session);
  }
  ...
  getSuggestions(): Observable<{ label: string; prompt: string }[]> {
    return this.http.get<{ label: string; prompt: string }[]>(`${this.apiUrl}/suggestions`);
  }
